...
public class GraphManager {
    ...
    public Graph createGraph(String filePathToGraphMatrix, String filePathToAlpha,
        ...
        List<String> alphas = readerHelper.readAlphaFromFile(filePathToAlpha);
        List<String> betas = readerHelper.readBetaFromFile(filePathToBeta);
        List<String> s = readerHelper.readSFromFile(filePathToS);
        List<String> optimizationParams = readerHelper.readSFromFile(filePathToOptimizationParams);
